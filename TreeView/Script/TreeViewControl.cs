...
public class TreeViewControl : MonoBehaviour
{
    ...
    /// 树形菜单中元素的模板
    /// </summary>
    public GameObject FirstLevelTemplate;
    public GameObject SecondLevelTemplate;
    /// <summary>
    /// 树形菜单中元素的根物体
    /// </summary>
    ...
    /// 树形菜单中元素的高度
    /// </summary>
    public int FirstItemHeight = 35;
    public int SecondItemHeight = 50;
    /// <summary>
    /// 所有子元素的鼠标点击回调事件
    /// </summary>
    ...
    //当前树形菜单中的所有元素
    private List<GameObject> _treeViewItems = new List<GameObject>();
    //当前树形菜单中的所有元素克隆体（刷新树形菜单时用于过滤计算）
    private List<GameObject> _treeViewItemsClone;
    private Dictionary<int, GameObject> _tmpTree = new Dictionary<int, GameObject>();
    //树形菜单当前刷新队列的元素位置索引
    ...
    public void RefreshTreeView()
    {
        ...
        for (int i = 0; i < _treeViewItemsClone.Count; i++)
        {
            ...
            _yIndex += (-(FirstItemHeight + VerticalItemSpace));
    ...
    void RefreshTreeViewChild(TreeViewItem tvi)
    {
        for (int i = 0; i < tvi.GetChildrenNumber(); i++)
        {
            ...
            _yIndex += (-(SecondItemHeight + VerticalItemSpace));
